...
namespace UIT.iDeal.Acceptance.UserStories.US001
{
    public abstract class us001_sc01<T> : ScenarioFor<T, us001_create_new_user_login> where T : class
    {
        ...
        public abstract void And_the_user_first_name_should_be_empty();
        public abstract void And_the_user_last_name_should_be_empty();
        public abstract void And_the_user_name_should_be_empty();
        public abstract void And_the_user_email_should_be_empty();
        public abstract void And_the_user_application_role_should_not_be_selected();
        public abstract void And_the_user_business_unit_should_not_be_selected();
